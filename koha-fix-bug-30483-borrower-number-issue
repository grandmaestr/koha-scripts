...
Arguments:
  koha_instance_name   The name of one or more Koha instances to fix the error for.
...
Example:
  $(basename "$0") your_koha_instance_name another_koha_instance_name
EOF
}
...
echo "The columns borrowernumber and itemnumber have been updated to NOT NULL and foreign key constraints have been re-added for instance $koha_instance_name."
done