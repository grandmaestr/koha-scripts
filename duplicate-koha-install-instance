...
echo $'\nEnter the name of your Koha instance:'
...
echo $'\nYou will need to configure your instance for name-based or ip installation. See /etc/apache2/sites-available/$instancename for more.'
sleep 2
...
echo $'\nEnter the your OPAC url only (Skip http:// or https://):'
read  opacurl
echo $'\nYour OPAC url is: $opacurl'
...
echo $'\nEnter the your Staff url only (Skip http:// or https://):'
read  staffurl
echo $'\nYour Staff url is: $opacurl'
...
echo $'\nIf you come across any errors, go to /etc/apache2/sites-enabled/$instancename.'
sleep 2
...
echo $'\nThe Koha instance $instancename has been successfully installed'
