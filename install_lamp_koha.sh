...
# Secure MariaDB. You will recieve a number of prompts. This will ask if you want to configure the VALIDATE PASSWORD PLUGIN. It is best to answer No.
...
echo You will need to configure your instance for name-based or ip installation. See /etc/apache2/sites-available/$instancename
